...
if (isset($_POST['btnupdateorder'])) {
    ...
    //Getting values from text feilds and from array in variables.
    ...
    //update query for tbl_product stock.
    ...
    //delete query for tbl_invoice_details table data where invoice_id =$id .
    ...
    //update query for tbl_invoice table data.
    ...
    if ($invoice_id != null) {
        ...
        for ($i = 0; $i < count($arr_productid); $i++) {
            ...
            //select query for tbl_product table to get out stock value.    
            ...
            while ($rowpdt = $selectpdt->fetch(PDO::FETCH_OBJ)) {
                ...
                if ($rem_qty < 0) {
                    ...
                    //update query for tbl_product table to update stock values.
            ...
            //insert query for tbl_invoice_details for insert new records.
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#"><i class="fa fa-list-ul"></i>Order List</a></li>
        ...
        <div class="box box-info">
            <form action="" method="post" name="">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title"><a href="orderlist.php" class="btn btn-info" role="button">Back To Order
                            List</a></h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                ...
                <div align="center">
                    ...
                    <input type="submit" name="btnupdateorder" value="Update" class="btn btn-warning">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btnadd', function() {
            ...
            html +=
                '<td><select class="form-control productid" name="productid[]" style="width: 250px";><option value="">Select Option</option><?php echo fill_product($pdo, '
        '); ?> </select></td>';
